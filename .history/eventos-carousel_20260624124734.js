...
(function() {
    ...
    artistCards.forEach(card => {
        card.addEventListener('click', function(e) {
            ...
            const { name, desc, instagram, facebook, youtube, twitter, tiktok } = this.dataset;
            const photoImg = this.querySelector('.artist-photo img');
            const photoSrc = photoImg ? photoImg.src : '';
            const initials = this.querySelector('.artist-initials');
            ...
            if (photoSrc && photoImg.style.display !== 'none') {
                ...
                modalInitials.textContent = initials ? initials.textContent : '';
            }
            ...
            const socials = [
                ...
                { url: twitter, icon: '🐦', name: 'Twitter' },
                { url: tiktok, icon: '🎵', name: 'TikTok' }
            ];
            ...
            socials.forEach(s => {
                if (s.url) {
                    ...
                    link.innerHTML = `<span class="social-icon">${s.icon}</span><span>${s.name}</span>`;
